...
@Component({
  ...
  template: `
    <div
      class="w-fit inset-shadow-md shadow-lg shadow-black/10 ring-1 ring-black/10  px-4 py-2 rounded-2xl bg-zinc-50/10 backdrop-blur-sm "
    >
      <div class="grid gap-2">
        <p class="text-[0.65rem] uppercase font-semibold text-zinc-500 ">Currently playing</p>
        ...
        <div class="flex gap-2">
          ...
          <div class="self-center">
            <h3 class="text-lg font-semibold tracking-tight text-zinc-800">
              {{ songTitle() }}
            </h3>
            <p class="text-[15px] text-zinc-700">{{ songArtist() }}</p>
          </div>
        </div>

        <div class="flex items-center gap-3 w-full min-w-[220px] pt-0.5 px-1">
          <div class="text-[11px] tabular-nums text-zinc-500 shrink-0 font-medium">
            {{ formatTime(63) }}
          </div>
          <div class="flex-1 min-w-0 w-62 h-1.5 rounded-full cursor-pointer bg-gray-400/50 mb-0">
            <div class="h-full rounded-full bg-zinc-800 w-2/5"></div>
          </div>
          <div class="text-[11px] tabular-nums text-zinc-500 shrink-0 font-medium">
            {{ formatTime(157) }}
          </div>
          ...
          <div class="flex items-center gap-3 ml-auto">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                class="rotate-180 size-13.5 text-zinc-800"
              >
                <path d="M11 7.8l-5 4.2 5 4.2c.4.35 1 .05 1-.5V8.3c0-.55-.6-.85-1-.5z" />
                <path d="M17.2 7.8l-5 4.2 5 4.2c.4.35 1 .05 1-.5V8.3c0-.55-.6-.85-1-.5z" />
              </svg>
